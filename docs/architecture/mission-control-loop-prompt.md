...
6. 只有当 `docs/todo/mission-control.md` 当前循环范围内的 checklist 全部完成，并且首个 host 的 prompt/checklist confirmation、paused-state resolution、loop snapshot UX 相关未勾项也已完成时，才可进入 `DONE`。
